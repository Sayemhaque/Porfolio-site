...
export const projects = [
    ...
    },
    {
        ...
        img: toyCastleImg,
        stack: "MERN STACK",
        details:"The Toy Castle web app is built using the MERN stack with Firebase authentication. Users must register to explore all features, including adding toys and accessing the protected toy details page. Logged-in users can update and delete their own toys on the My Toys page, while the All Toys page offers a search system to find toys by name.",
    ...
    },
    {
        ...
        img: sportifyImg,
        stack: "MERN STACK",
        details:" Sportify is a feature-rich web application catering to sports enthusiasts. It incorporates JWT authorization for secure authentication, role-based routing, and dedicated admin/instructor panels. Firebase authentication ensures reliable user verification, while Stripe integration enables seamless online payments. With its comprehensive features, Sportify offers a robust platform for users to connect, explore sports classes, and make secure online payments.",

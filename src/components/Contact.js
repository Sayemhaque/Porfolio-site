            ...
            <div className="max-w-[1000px] mx-auto pt-10">
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 shadow-lg '>
                    <form ref={form} onSubmit={sendEmail} data-aos="fade-right"
                        ...
                        <input required type="text" name='from_name' className='px-5 py-1 border-black bg-opacity-30 bg-white focus:border-none' placeholder='your name' />
                        <input required type="email" name='from_email' className='px-5 py-1 border-black bg-opacity-30 bg-white focus:border-none' placeholder='email' />
                        <textarea required name='message' cols={5} rows={10} type="text" className='px-5 py-1 border-black bg-opacity-30 bg-white focus:border-none' placeholder='write massage...' />

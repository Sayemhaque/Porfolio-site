...
const Hero = () => {
    return (
        <section name='home' className="w-full   bg-[#5CDB95] ">
            
            <div className="max-w-[1000px]  bg-[#EDF5E1] min-h-screen  bg-opacity-30 shadow-lg mx-auto px-8  flex flex-col space-y-7 justify-center items-center ">
               ...
               <h3 className="text-4xl md:text-6xl font-bold text-center  font-sans ">Front-end web developer</h3>

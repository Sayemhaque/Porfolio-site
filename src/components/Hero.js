        ...
        <section name='home' className="bg-[#5CDB95] ">
            ...
            <div className="max-w-[1000px]  bg-[#EDF5E1] min-h-screen  bg-opacity-30 shadow-lg mx-auto px-8  flex flex-col space-y-5 justify-center items-center ">
                <img data-aos="flip-left"
                    ...
                    data-aos-duration="2000" src="https://pbs.twimg.com/profile_images/1571873505855279105/MyMY1U9y_400x400.jpg" className="rounded-full object-contain h-[200px] w-[200px] sm:h-[300px] sm:w-[300px]" alt="" />
